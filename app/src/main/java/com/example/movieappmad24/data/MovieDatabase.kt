...
@Database(
    ...
    version = 26,                // schema version; whenever you change schema you have to increase the version number
...
abstract class MovieDatabase: RoomDatabase() {
                ...
                ?: synchronized(this) { // wrap in synchronized block to prevent race conditions
                    Room.databaseBuilder(context, MovieDatabase::class.java, "movie_db")
                        ...
                        .also {
                            ...
                            Log.d("MovieDatabase", "Database instance created")
                        }
                }
        }
    }
    ...
    private class DatabaseCallback(private val scope: CoroutineScope) : Callback() {
        override fun onCreate(db: SupportSQLiteDatabase) {
            Log.d("DatabaseCallback", "BEVOR onCreate - Database creation callback triggered")
            super.onCreate(db)
            Log.d("DatabaseCallback", "onCreate - Database creation callback triggered")
            instance?.let { database ->
                scope.launch {
                    try {
                        Log.d("DatabaseCallback", "Starting to populate the database")
                        prePopulateDatabase(database.movieDao())
                        Log.d("DatabaseCallback", "Database populated successfully")
                    } catch (e: Exception) {
                        Log.e("DatabaseCallback", "Error populating database: ${e.message}", e)
                    }
                }
            } ?: Log.e("DatabaseCallback", "Database instance is null")
        }
        ...
        private suspend fun prePopulateDatabase(dao: MovieDao) {
            ...
            if (movies.isNotEmpty()) {
                dao.addAll(movies)
                Log.d("DatabaseCallback", "Movies added: ${movies.size}")
            } else {
                Log.d("DatabaseCallback", "No movies to add")
            }

            val images = getMovieImages()
            Log.d("images", "images added: $images")
            if (images.isNotEmpty()) {
                dao.addImages(images)
                Log.d("DatabaseCallback", "Images added: ${images.size}")
            } else {
                Log.d("DatabaseCallback", "No images to add")
            }
        }
    ...
    fun getMovies(): List<Movie> {
        ...
        fun getMovieImages(): List<MovieImage> {
            return listOf(
                MovieImage(
                    movieId = "tt0499549",
                ...
                MovieImage(
                    movieId = "tt0944947",
                    url = "https://images-na.ssl-images-amazon.com/images/M/MV5BMDk4Y2Y1MDAtNGVmMC00ZTlhLTlmMmQtYjcyN2VkNzUzZjg2XkEyXkFqcGdeQXVyNjUxNzgwNTE@._V1_SX1777_CR0,0,1777,999_AL_.jpg"
                ),
                MovieImage(
                    movieId = "tt0944947",
                    url = "https://images-na.ssl-images-amazon0.com/images/M/MV5BNjZjNWIzMzQtZWZjYy00ZTkwLWJiMTYtOWRkZDBhNWJhY2JmXkEyXkFqcGdeQXVyMjk3NTUyOTc@._V1_SX1777_CR0,0,1777,999_AL_.jpg"
                ),
                MovieImage(
                    movieId = "tt0944947",
                ...
                MovieImage(
                    movieId = "tt0903747",
                    url = "https://images-na.ssl-images-amazon.com/images/M/MV5BMTgyMzI5NDc5Nl5BMl5BanBnXkFtZTgwMjM0MTI2MDE@._V1_SY1000_CR0,0,1498,1000_AL_.jpg"
                ),
                MovieImage(
                    movieId = "tt0903747",
                    url = "https://images-na.ssl-images-amazon.com/images/M/MV5BMTQ2NDkwNDk5NV5BMl5BanBnXkFtZTgwNDM0MTI2MDE@._V1_SY1000_CR0,0,1495,1000_AL_.jpg"
                ),
                MovieImage(
                    movieId = "tt0903747",
                    url = "https://images-na.ssl-images-amazon.com/images/M/MV5BMTM4NDcyNDMzMF5BMl5BanBnXkFtZTgwOTI0MTI2MDE@._V1_SY1000_CR0,0,1495,1000_AL_.jpg"
                ),
                MovieImage(
                    movieId = "tt0903747",
                    url = "https://images-na.ssl-images-amazon.com/images/M/MV5BMTAzMTczMjM3NjFeQTJeQWpwZ15BbWU4MDc1MTI1MzAx._V1_SY1000_CR0,0,1495,1000_AL_.jpg"
                ),
                MovieImage(
                    movieId = "tt0903747",
                    url = "https://images-na.ssl-images-amazon.com/images/M/MV5BMjA5MTE3MTgwMF5BMl5BanBnXkFtZTgwOTQxMjUzMDE@._V1_SX1500_CR0,0,1500,999_AL_.jpg"
                ),
                MovieImage(
                    movieId = "tt2707408",
